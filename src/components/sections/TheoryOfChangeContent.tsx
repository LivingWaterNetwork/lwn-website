...
export function TheoryOfChangeContent() {
  return (
    <>
      {/* ── Hero ── */}
      <section className="relative bg-navy py-24 text-white text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4">
          ...
          <h1 className="font-serif text-5xl md:text-6xl font-semibold leading-tight mb-5">
            <RevealText text="Our Theory of Change" delay={0.1} />
          </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionHeading className="mb-5" label="The Core Belief" heading="Formed Leaders Change Everything Around Them" />
      ...
      <section className="py-16 bg-mist">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            className="mb-12"
            label="The Logic Model"
            heading="Inputs → Activities → Outputs → Outcomes → Impact"
            subheading="Each stage builds on the one before it. This is the same chain we use internally to evaluate whether the program is actually working."
            subheadingClassName="mt-3 text-slate font-sans text-sm max-w-2xl"
          />

          {/* Sequential, stepped reveal — the model "building itself" as you scroll */}
          <StaggerChildren className="grid md:grid-cols-5 gap-4">
            {stages.map((stage, i) => (
              <StaggerItem key={stage.label} className="relative flex flex-col">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            className="mb-12"
            label="Why We Believe This Works"
            heading="The Assumptions Behind the Model"
            subheading="Every theory of change rests on assumptions. Here are ours, stated plainly so they can be examined and tested."
            subheadingClassName="mt-3 text-slate font-sans text-sm max-w-2xl"
          />
      ...
      <section className="py-16 bg-navy text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subheading="As our first cohort launches in Spring 2027, we are building measurement into the program from day one — not adding it after the fact."
          ...
          <StaggerChildren className="grid sm:grid-cols-2 gap-4">
            {measures.map(({ icon, title, body }) => (
              <StaggerItem key={title} className="bg-white/5 border border-white/10 rounded-xl p-5">
