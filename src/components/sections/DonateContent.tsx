  ...
  return (
    <>
      ...
      <section className="bg-navy py-20 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-semibold leading-tight">
            <RevealText text="Your Generosity Ignites Transformation" delay={0.15} />
          </h1>
          <motion.p
            className="mt-4 text-white/65 text-lg max-w-xl mx-auto font-sans"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="bg-white py-12 border-b border-mist">
        <StaggerChildren className="max-w-4xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          {[
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            label="Your Impact"
            heading="What You're Funding"
            subheading="Every dollar goes directly to forming and releasing Kingdom leaders. Here's what that looks like in practice."
            labelClassName="section-label mb-3"
          ...
          {/* Dollar tier cards */}
          <StaggerChildren className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
          ...
          {/* Program breakdown */}
          <FadeInSection className="bg-mist rounded-2xl p-8">
      ...
      <section className="py-16 bg-mist">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subheading="Secure giving powered by Stripe. One-time or recurring."
            labelClassName="section-label mb-2"
            subheadingClassName="text-slate font-sans text-sm mt-2"
            className="mb-8"
          />
          <FadeInSection>
            <DonateForm />
