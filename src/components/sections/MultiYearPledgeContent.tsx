...
export function MultiYearPledgeContent() {
  return (
    <>
      <section className="py-24 bg-navy text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-semibold leading-tight mb-6">
            <RevealText text="Build Something That Lasts" />
          </h1>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <StaggerChildren className="grid sm:grid-cols-3 gap-4">
            {roadmap.map(({ phase, goal, focus }) => (
              <StaggerItem key={phase} className="bg-mist rounded-xl p-5 text-left">
      ...
      <section className="py-16 bg-mist">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading className="mb-8" label="Let's Discuss Your Pledge" heading="We'd Be Honored" />
          <FadeInSection>
            <InquiryForm
