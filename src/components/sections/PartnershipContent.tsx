    ...
    <>
      ...
      <section className="bg-navy py-24 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-semibold leading-tight mb-6">
            <RevealText text="Invest in the Leaders" />
            <br />
            <span className="italic">
              <RevealText text="Who Change the World" delay={0.15} />
            </span>
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading className="mb-12" label="The Vision" heading="Why This Matters" />
          <StaggerChildren className="grid md:grid-cols-3 gap-8 text-center">
            {whyPartnerStats.map(({ stat, label, desc, animate }) => (
              <StaggerItem key={stat} className="bg-mist rounded-2xl p-8">
                <p className="font-serif text-4xl font-semibold text-navy">
                  {animate ? <CountUp value={stat} /> : stat}
                </p>
      ...
      <section id="tiers" className="py-20 bg-mist">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            heading="Choose Your Level of Investment"
            subheading="All partnerships are renewable annually. Multi-year pledges are available — see below."
            subheadingClassName="text-slate font-sans text-sm max-w-xl mx-auto mt-3 leading-relaxed"
          />

          <StaggerChildren className="grid md:grid-cols-2 gap-6">
            {tiers.map(({ name, amount, period, tagline, color, accentColor, benefits }) => (
              <StaggerItem key={name} className={`rounded-2xl p-7 shadow-sm ${color}`}>
                ...
                <p className="font-sans text-3xl font-bold mb-1">
                  {amount.includes("–") ? amount : <CountUp value={amount} />}
                </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            heading="Give Monthly. Change Everything."
            subheading="Recurring gifts are the backbone of our operating budget. Every monthly member makes it possible to plan, hire, and expand with confidence."
            subheadingClassName="text-slate font-sans text-sm max-w-xl mx-auto mt-3 leading-relaxed"
          />
      ...
      <section className="py-20 bg-navy text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionHeading
            ...
            headingClassName="font-serif text-3xl md:text-4xl font-semibold leading-tight text-white"
          />
          <FadeInSection>
          ...
          <StaggerChildren className="grid sm:grid-cols-3 gap-4 mb-12">
            {roadmap.map(({ phase, goal, focus }) => (
              <StaggerItem key={phase} className="bg-white/5 border border-white/10 rounded-xl p-5 text-left">
                <p className="text-xs font-extrabold font-sans uppercase tracking-widest text-copper mb-2">
                  {phase}
                </p>
                <p className="font-serif text-2xl font-semibold text-white mb-2">
                  <CountUp value={goal} />
                </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            heading="Help Us Build the Room"
            subheading="The LWN Black Tie Gala is our primary annual fundraising event — 150 CEOs and executive pastors, Black Tie, Atlanta. A high-scale vision night and Kingdom networking experience that launches each year of ministry. We need partners to help make it possible."
            subheadingClassName="text-slate font-sans text-sm max-w-2xl mx-auto mt-3 leading-relaxed"
          />
          ...
          <StaggerChildren className="grid sm:grid-cols-3 gap-4 mb-12">
            {[
              ...
              <StaggerItem key={label} className="bg-mist rounded-xl p-6 text-center">
          ...
          <StaggerChildren className="grid md:grid-cols-2 gap-6 mb-10">
            <StaggerItem className="bg-mist rounded-xl p-6">
      ...
      <section className="py-20 bg-mist">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <SectionHeading className="mb-4" label="Ready to Partner?" heading="Let's Start the Conversation" />
          <FadeInSection>
