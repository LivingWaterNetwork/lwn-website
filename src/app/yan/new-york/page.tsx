...
const city = getYanCity("new-york")!;
const otherCities = getOtherCities("new-york");

export const metadata: Metadata = {
  ...canonical("/yan/new-york"),
  title: "YAN New York City | Young Adults Network NYC",
  description:
    "YAN is coming to New York City — connecting the young-adult ministries, groups, pastors, and leaders across the five boroughs into one shared mission.",
  openGraph: {
    title: "YAN New York City | Young Adults Network NYC",
    description: "The YAN movement, taking root in New York City. Help build the launch team.",
    type: "website",
    images: [{ url: "/images/yan/source/nyc-aerial-skyline.jpg", width: 1200, height: 630, alt: "Aerial view of the New York City skyline" }],
  },
};

export default function YanNewYorkPage() {
  return (
    <>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([{ name: "YAN", path: "/yan" }, { name: "New York City", path: "/yan/new-york" }])) }}
      />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24 sm:pt-36 sm:pb-32 text-center">
          <FadeInSection>
            <p className="yan-eyebrow yan-eyebrow-dark mb-5">YAN New York City &middot; {city.stageBadge}</p>
            ...
            <p className="yan-body text-white/75 max-w-2xl mx-auto mb-10 text-lg">
              ...
              steps in New York City — and it starts with the leaders willing to help build it.
            </p>
            <Link href="/yan/join?path=ministry-leader&city=New%20York%20City" className="yan-btn-primary">
              Help Launch YAN NYC
            </Link>
          </FadeInSection>
        </div>
      ...
      <section className="bg-white py-20 sm:py-28">
        <FadeInSection className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="yan-body text-yan-navy/65 text-lg leading-relaxed mb-4">
            ...
            That same simple idea is now finding its way to New York City.
          </p>
          <p className="yan-body text-yan-navy/65 text-lg leading-relaxed">
            ...
            beginning. If you lead a young-adult ministry, group, or church in the five boroughs,
            you&apos;d be one of the first voices shaping what YAN NYC becomes.
          </p>
        </FadeInSection>
      </section>

      {/* NYC imagery + neighborhoods */}
      <section className="bg-yan-navy py-20 sm:py-28 relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <FadeInSection className="text-center mb-14">
            ...
            <h2 className="yan-h2 text-white mb-5">From Brooklyn to the Bronx.</h2>
            <p className="yan-body text-white/60 max-w-2xl mx-auto">
              Young-adult ministries are already at work across every borough. YAN NYC exists to
          ...
          <FadeInSection delay={0.1}>
            <div className="relative rounded-2xl overflow-hidden aspect-[16/9] sm:aspect-[21/9]">
              <Image src="/images/yan/source/nyc-times-square-street.jpg" alt="A New York City street and neighborhood block" fill className="object-cover" />
              ...
              <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 flex flex-wrap gap-2">
                {["Manhattan", "Brooklyn", "Queens", "The Bronx", "Staten Island"].map((n) => (
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInSection>
            <YanEmptyState
              eyebrow="The Network"
              title="YAN NYC doesn't exist yet — you could help start it."
              ...
              ctaHref="/yan/join?path=ministry-leader&city=New%20York%20City"
      ...
      <section className="bg-yan-stone py-20 sm:py-28">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInSection>
            ...
            <h2 className="text-center yan-h3 text-yan-navy mb-6">Tell us about your NYC ministry</h2>
            <YanGroupSuggestForm city="New York City" />
          </FadeInSection>
        </div>
      </section>
      ...
      <section className="bg-white py-16 sm:py-20 border-t border-yan-navy/5">
        <FadeInSection className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="yan-h3 text-yan-navy mb-4">New York isn&apos;t alone in this.</h2>
          <p className="text-yan-navy/60 font-yan-body mb-8 max-w-xl mx-auto">
            YAN NYC shares the same foundation as every other hub — starting with Atlanta, where the
            movement began, and Los Angeles, launching alongside New York.
          </p>
